    ...
    try {
        ...
        for (let i = 0; i < data["data"]["completions"].length; i++) {
            ...
            if (c["uuid"] == versusUUID) {
                finalTime = c["time"];
                finished = true;
                versus_timings2["ALL"]["completions"][0] += c["time"];
                versus_timings2["ALL"]["completions"][1] += 1;
                versus_timings2[overworldType]["completions"][0] += c["time"];
                versus_timings2[overworldType]["completions"][1] += 1;
                break;
            }
        }
        ...
        for (let i = timelines.length - 1; i >= 0; i--) { // Start in ow, end in completion
            ...
            switch (timeline["type"]) {
                case "projectelo.timeline.reset":
                    latestReset = timeline["time"];
                    versus_timings2["ALL"][latestSplit]["resets"] += 1;
                    versus_timings2[overworldType][latestSplit]["resets"] += 1;
                    if (latestSplit == "bastion") {
                        versus_bastions2["ALL"][bastionType][4] += 1;
                        versus_bastions2[overworldType][bastionType][4] += 1;
                    }
                    break;

                case "projectelo.timeline.death":
                    versus_timings2["ALL"][latestSplit]["deaths"] += 1;
                    versus_timings2[overworldType][latestSplit]["deaths"] += 1;
                    if (latestSplit == "bastion") {
                        versus_bastions2["ALL"][bastionType][3] += 1;
                        versus_bastions2[overworldType][bastionType][3] += 1;
                    }
                    break;
                
                case "story.enter_the_nether":
                    timestamps["enter_nether"] = timeline["time"];
                    versus_timings2["ALL"]["overworld"]["splits"][0] += timeline["time"] - latestReset;
                    versus_timings2["ALL"]["overworld"]["splits"][1] += 1;
                    versus_timings2["ALL"]["nether"]["timestamps"][0] += timeline["time"] - latestReset;
                    versus_timings2["ALL"]["nether"]["timestamps"][1] += 1;
                    versus_timings2[overworldType]["overworld"]["splits"][0] += timeline["time"] - latestReset;
                    versus_timings2[overworldType]["overworld"]["splits"][1] += 1;
                    versus_timings2[overworldType]["nether"]["timestamps"][0] += timeline["time"] - latestReset;
                    versus_timings2[overworldType]["nether"]["timestamps"][1] += 1;
                    latestSplit = "nether";
                    if (overworldType != null) {
                ...
                case "nether.find_bastion":
                    timestamps["enter_bastion"] = timeline["time"];
                    versus_timings2["ALL"]["bastion"]["timestamps"][0] += timeline["time"] - latestReset;
                    versus_timings2["ALL"]["bastion"]["timestamps"][1] += 1;
                    versus_timings2["ALL"]["nether"]["splits"][0] += timeline["time"] - timestamps["enter_nether"];
                    versus_timings2["ALL"]["nether"]["splits"][1] += 1;
                    versus_timings2[overworldType]["bastion"]["timestamps"][0] += timeline["time"] - latestReset;
                    versus_timings2[overworldType]["bastion"]["timestamps"][1] += 1;
                    versus_timings2[overworldType]["nether"]["splits"][0] += timeline["time"] - timestamps["enter_nether"];
                    versus_timings2[overworldType]["nether"]["splits"][1] += 1;
                    latestSplit = "bastion";
                    if (bastionType != null) {
                        versus_bastions2["ALL"][bastionType][2] += 1;
                        versus_bastions2[overworldType][bastionType][2] += 1;
                    }
                    break;
                
                case "nether.find_fortress":
                    timestamps["enter_fortress"] = timeline["time"];
                    versus_timings2["ALL"]["fortress"]["timestamps"][0] += timeline["time"] - latestReset;
                    versus_timings2["ALL"]["fortress"]["timestamps"][1] += 1;
                    versus_timings2["ALL"]["bastion"]["splits"][0] += timeline["time"] - timestamps["enter_bastion"];
                    versus_timings2["ALL"]["bastion"]["splits"][1] += 1;
                    versus_timings2[overworldType]["fortress"]["timestamps"][0] += timeline["time"] - latestReset;
                    versus_timings2[overworldType]["fortress"]["timestamps"][1] += 1;
                    versus_timings2[overworldType]["bastion"]["splits"][0] += timeline["time"] - timestamps["enter_bastion"];
                    versus_timings2[overworldType]["bastion"]["splits"][1] += 1;
                    latestSplit = "fortress";
                    if (bastionType != null) {
                        versus_bastions2["ALL"][bastionType][0] += timeline["time"] - timestamps["enter_bastion"];
                        versus_bastions2["ALL"][bastionType][1] += 1;
                        versus_bastions2[overworldType][bastionType][0] += timeline["time"] - timestamps["enter_bastion"];
                        versus_bastions2[overworldType][bastionType][1] += 1;
                    }
                    break;

                case "projectelo.timeline.blind_travel":
                    timestamps["blind"] = timeline["time"];
                    versus_timings2["ALL"]["blind"]["timestamps"][0] += timeline["time"] - latestReset;
                    versus_timings2["ALL"]["blind"]["timestamps"][1] += 1;
                    versus_timings2["ALL"]["fortress"]["splits"][0] += timeline["time"] - timestamps["enter_fortress"];
                    versus_timings2["ALL"]["fortress"]["splits"][1] += 1;
                    versus_timings2[overworldType]["blind"]["timestamps"][0] += timeline["time"] - latestReset;
                    versus_timings2[overworldType]["blind"]["timestamps"][1] += 1;
                    versus_timings2[overworldType]["fortress"]["splits"][0] += timeline["time"] - timestamps["enter_fortress"];
                    versus_timings2[overworldType]["fortress"]["splits"][1] += 1;
                    latestSplit = "blind";
                    break;

                case "story.follow_ender_eye":
                    timestamps["enter_stronghold"] = timeline["time"];
                    versus_timings2["ALL"]["stronghold"]["timestamps"][0] += timeline["time"] - latestReset;
                    versus_timings2["ALL"]["stronghold"]["timestamps"][1] += 1;
                    versus_timings2["ALL"]["blind"]["splits"][0] += timeline["time"] - timestamps["blind"];
                    versus_timings2["ALL"]["blind"]["splits"][1] += 1;
                    versus_timings2[overworldType]["stronghold"]["timestamps"][0] += timeline["time"] - latestReset;
                    versus_timings2[overworldType]["stronghold"]["timestamps"][1] += 1;
                    versus_timings2[overworldType]["blind"]["splits"][0] += timeline["time"] - timestamps["blind"];
                    versus_timings2[overworldType]["blind"]["splits"][1] += 1;
                    latestSplit = "stronghold";
                    break;

                case "story.enter_the_end":
                    timestamps["enter_end"] = timeline["time"];
                    versus_timings2["ALL"]["end"]["timestamps"][0] += timeline["time"] - latestReset;
                    versus_timings2["ALL"]["end"]["timestamps"][1] += 1;
                    versus_timings2["ALL"]["stronghold"]["splits"][0] += timeline["time"] - timestamps["enter_stronghold"];
                    versus_timings2["ALL"]["stronghold"]["splits"][1] += 1;    
                    versus_timings2[overworldType]["end"]["timestamps"][0] += timeline["time"] - latestReset;
                    versus_timings2[overworldType]["end"]["timestamps"][1] += 1;
                    versus_timings2[overworldType]["stronghold"]["splits"][0] += timeline["time"] - timestamps["enter_stronghold"];
                    versus_timings2[overworldType]["stronghold"]["splits"][1] += 1;    
                    latestSplit = "end";
                    break;
            }
        }
        ...
        if (finished) {
            versus_timings2["ALL"]["end"]["splits"][0] += finalTime - timestamps["enter_end"];
            versus_timings2["ALL"]["end"]["splits"][1] += 1;
            versus_timings2[overworldType]["end"]["splits"][0] += finalTime - timestamps["enter_end"];
            versus_timings2[overworldType]["end"]["splits"][1] += 1;
        }
    } catch (error) {
        console.error("ERROR IN 'versus_call_Ranked_GetMatch2': ", error);
    }
}
